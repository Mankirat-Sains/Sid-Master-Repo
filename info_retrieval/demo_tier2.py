...
def main() -> None:
    ...
    # Fail fast if required keys are missing; SupabaseVectorStore will also raise.
    ...
    # Initialize dependencies for the Tier2 RAG generator (same path as backend docgen).
    config = load_config()
    ...
    print("\n=== Length Target ===")
    print(result.get("length_target"))
