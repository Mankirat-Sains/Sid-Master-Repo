            ...
            for cell in row:
                if cell.value:
                    ...
                    if cell.font and cell.font.color and hasattr(cell.font.color, 'rgb'):
                        text_color = str(cell.font.color.rgb) if cell.font.color.rgb else None
                    
                    # Only include cells with interesting colors
                    if fill_color and fill_color not in ['00000000', 'FFFFFFFF', 'None', None]:
...
- User inputs / editable cells
- Calculated values / formulas
- Output results / things to review
...
def classify_cells_by_ai_legend(file_path: Path, sheet_name: str, color_mappings: dict) -> dict:
    ...
    for row in ws.iter_rows(min_row=1, max_row=200, min_col=1, max_col=50):
        for cell in row:
            ...
            if fill_color and fill_color in color_mappings:
                ...
                cell_info = {
                    ...
                    "color": fill_color,
                    "category": category,
                    "description": color_mappings[fill_color].get("description", ""),
