...
{
  //Sidian theme - Purple with white background
  public static readonly Color Primary = Color.FromRgb(106, 27, 154); // Purple #6A1B9A
  public static readonly Color Secondary = Color.FromRgb(74, 20, 140); // Primary Focus #4A148C
  public static readonly Color Accent = Color.FromRgb(255, 191, 0); // Keep accent yellow for highlights
