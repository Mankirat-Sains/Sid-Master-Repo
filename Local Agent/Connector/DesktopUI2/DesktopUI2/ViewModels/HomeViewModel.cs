...
public class HomeViewModel : ReactiveObject, IRoutableViewModel
{
  ...
  public void ToggleDarkThemeCommand()
  {
    ...
    var isCurrentlyDark = materialTheme.CurrentTheme.GetBaseTheme() == BaseThemeMode.Dark;
    
    // Toggle to the opposite theme
    var newThemeIsDark = !isCurrentlyDark;
    MainViewModel.Instance.ChangeTheme(newThemeIsDark);

    var config = ConfigManager.Load();
    config.DarkTheme = newThemeIsDark;
