...
// Supabase Storage Configuration Functions
export function getSupabaseUrl() {
  return getStringFromEnv('SUPABASE_URL')
}

export function getSupabaseServiceRoleKey() {
  return getStringFromEnv('SUPABASE_SERVICE_ROLE_KEY')
}

export function getSupabaseBucketName() {
  return getStringFromEnv('SUPABASE_BUCKET_NAME', { default: 'Speckle' })
}

export function getStorageProvider(): 's3' | 'supabase' {
