...
def draft_report(state: RAGState) -> dict:
    """Generate a multi-section report draft and stash in state."""
    log_query.info("DOCGEN: entered draft_report (task_type=%s)", state.task_type)
    try:
...
node_doc_generate_report = draft_report

__all__ = ["draft_report", "node_doc_generate_report"]
