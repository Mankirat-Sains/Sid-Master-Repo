...
from nodes.DesktopAgent.WordAgent.section_generator import _clean_draft_text  # type: ignore
...
class DocGenTool:
    ...
    def generate_document(
        ...
        workspace_dir: Path,
        thread_id: str,
        state: Optional[DesktopAgentState] = None,
    ) -> Dict[str, Any]:
    ...
    def _prepare_context(
        ...
        workspace_dir: Path,
        state: Optional[DesktopAgentState],
    ) -> Path:
    ...
    def _call_docgen_subgraph(
        ...
        try:
            from nodes.DesktopAgent.WordAgent.section_generator import SectionGenerator  # type: ignore
