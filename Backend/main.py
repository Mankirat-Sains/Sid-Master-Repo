...
def run_agentic_rag(
    ...
    return {
        ...
        "support": getattr(final_state, "answer_support_score", 0.0),
        ...
        "expanded_queries": getattr(final_state, "expanded_queries", []),
        "latency_s": latency,
        "graded_preview": graded_preview,
        "plan": {"reasoning": "", "steps": [], "subqueries": []},
        "image_similarity_results": getattr(final_state, "image_similarity_results", []),
        "follow_up_questions": getattr(final_state, "follow_up_questions", []),
        "follow_up_suggestions": getattr(final_state, "follow_up_suggestions", []),
    }
