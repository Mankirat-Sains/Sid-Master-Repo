...
def build_doc_generation_subgraph():
    ...
    g.add_node("doc_plan", build_document_plan)
    g.add_node("doc_generate_section", draft_section)
    g.add_node("doc_generate_report", draft_report)
    g.add_node("doc_answer_adapter", adapt_generation_output)
