...
def call_doc_generation_subgraph(state: ParentState) -> dict:
    ...
    doc_state = RAGState(
        ...
        doc_type=getattr(state, "doc_type", None),
        doc_type_variant=getattr(state, "doc_type_variant", None),
        template_id=getattr(state, "template_id", None),
        template_sections=getattr(state, "template_sections", []),
        section_queue=getattr(state, "section_queue", []),
        approved_sections=getattr(state, "approved_sections", []),
        current_section_id=getattr(state, "current_section_id", None),
        section_type=getattr(state, "section_type", None),
    ...
    return {
        ...
        "doc_type_variant": result.get("doc_type_variant"),
